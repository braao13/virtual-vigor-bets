...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rabbet — Bolão Virtual de Futebol" },
      {
        name: "description",
        content: "Aposte com saldo virtual em partidas de futebol e compita com amigos no Rabbet.",
      },
      { property: "og:title", content: "Rabbet — Bolão Virtual de Futebol" },
      { property: "og:description", content: "Rabbet is a virtual football betting platform for friends using virtual currency." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Rabbet — Bolão Virtual de Futebol" },
      { name: "description", content: "Rabbet is a virtual football betting platform for friends using virtual currency." },
      { name: "twitter:description", content: "Rabbet is a virtual football betting platform for friends using virtual currency." },
